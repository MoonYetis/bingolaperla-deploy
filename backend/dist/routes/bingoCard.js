...
bingoCardController_1.BingoCardController.generateCards);
// GET /api/cards/user/:userId/game/:gameId - Obtener cartones de usuario (admin o propio usuario)
router.get('/user/:userId/game/:gameId', auth_1.authenticate, 
/* validateRequest(getUserCardsSchema), */
bingoCardController_1.BingoCardController.getUserCards);
// GET /api/cards/my/:gameId - Obtener mis cartones
router.get('/my/:gameId', auth_1.authenticate, 
/* validateRequest(getMyCardsSchema), */
bingoCardController_1.BingoCardController.getMyCards);
// PUT /api/cards/:cardId/mark - Marcar número en cartón
router.put('/:cardId/mark', auth_1.authenticate, 
/* validateRequest(markNumberSchema), */
bingoCardController_1.BingoCardController.markNumber);
// GET /api/cards/:cardId/patterns - Obtener patrones del cartón
router.get('/:cardId/patterns', auth_1.authenticate, 
/* validateRequest(getCardPatternsSchema), */
bingoCardController_1.BingoCardController.getCardPatterns);
// POST /api/cards/validate - Validar estructura de cartón
router.post('/validate', 
/* validateRequest(validateCardSchema), */
bingoCardController_1.BingoCardController.validateCard);
// DELETE /api/cards/:cardId - Eliminar/desactivar cartón
router.delete('/:cardId', auth_1.authenticate, 
/* validateRequest(deleteCardSchema), */
bingoCardController_1.BingoCardController.deleteCard);
