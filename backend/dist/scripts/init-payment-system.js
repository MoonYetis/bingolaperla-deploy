...
exports.initializePaymentSystem = initializePaymentSystem;
const client_1 = require("@prisma/client");
const structuredLogger_1 = require("../utils/structuredLogger");
const prisma = new client_1.PrismaClient();
async function initializePaymentSystem() {
    structuredLogger_1.logger.info('🏦 Inicializando Sistema de Pagos "Perlas"...');
    try {
        ...
        for (const config of bankConfigs) {
            ...
            structuredLogger_1.logger.info(`✅ Configuración bancaria creada/actualizada: ${config.bankName}`);
        }
        ...
        structuredLogger_1.logger.info('✅ Configuración del sistema de pagos creada');
        ...
        for (const user of users) {
            ...
            structuredLogger_1.logger.info(`✅ Billetera creada para usuario: ${user.username}`);
        }
        ...
        structuredLogger_1.logger.info('🎉 Sistema de Pagos "Perlas" inicializado exitosamente!');
        structuredLogger_1.logger.info('📊 Resumen de inicialización:', {
        ...
        structuredLogger_1.logger.error('❌ Error inicializando sistema de pagos:', error);
        throw error;
    }
    finally {
...
//# sourceMappingURL=init-payment-system.js.map