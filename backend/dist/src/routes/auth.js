...
(0, validation_1.validateRequest)({ body: authSchemas_1.registerSchema }), authController_1.AuthController.register);
/**
...
(0, validation_1.validateRequest)({ body: authSchemas_1.loginSchema }), authController_1.AuthController.login);
/**
 ...
 * @access  Private
 */
router.put('/profile', auth_1.fullAuthentication, (0, validation_1.validateRequest)({ body: authSchemas_1.updateProfileSchema }), authController_1.AuthController.updateProfile);
/**
 * @route   POST /api/auth/change-password
 * @desc    Cambiar contraseña del usuario
 * @access  Private
 */
router.post('/change-password', auth_1.fullAuthentication, (0, validation_1.validateRequest)({ body: authSchemas_1.changePasswordSchema }), authController_1.AuthController.changePassword);
